...
// renombra lo visible; el código se queda como nació.
// ============================================================================
              ...
              >
                ...
                {editingId === item.id ? (
                  ...
                  <>
                    ...
                    <span className="shrink-0 text-mini text-ink-soft/70" title="Código interno, no editable">
                      {item.code}
                    </span>
                    <span className="w-24 shrink-0 text-right text-mini text-ink-soft">
                      {used === 0 ? 'sin usar' : `${used} ${used === 1 ? 'unidad' : 'unidades'}`}
                    </span>
                    <button
...
export function TaxonomyPage() {
  const { data: categories, loading: loadingCategories, reload: reloadCategories } = useAsync(() =>
    UnitCategoryRepository.listAll(),
  )
